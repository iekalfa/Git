...
**Προαπαιτούμενα:** Απαιτεί κατανόηση commits (Επίπεδο 2), branches (Επίπεδο 3), και remotes (Επίπεδο 4). Τα εργαλεία αυτά λειτουργούν σε όλα τα προηγούμενα επίπεδα.
